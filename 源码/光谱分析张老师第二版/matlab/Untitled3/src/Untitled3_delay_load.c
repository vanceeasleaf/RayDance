 ...
 */
FARPROC WINAPI Untitled3DelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = Untitled3DelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = Untitled3DelayLoadWin32FailureHook;
#endif
