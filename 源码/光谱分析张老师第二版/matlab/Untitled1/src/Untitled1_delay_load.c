 ...
 */
FARPROC WINAPI Untitled1DelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = Untitled1DelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = Untitled1DelayLoadWin32FailureHook;
#endif
